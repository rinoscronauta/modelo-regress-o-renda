...
Para esta análise, os pacotes que utilizamos foram *PNADcIBGE*, *survey*, *dplyr*, *pander* e *reactable*. Utilizaremos microdados da PNAD Contínua do 1º trimestre de 2024, e selecionamos as variáveis de acordo com a tabela abaixo:
...
Antes da análise exploratória de dados, faremos a divisão dos nossos dados em conjuntos de treino e de teste.

```{r}

```

Podemos dar uma olhada nas primeiras 10 linhas do nosso DataFrame:
