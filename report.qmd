...
Para esta análise, os pacotes que utilizamos foram *PNADcIBGE*, *survey*, *tidyverse*, *pander* e *reactable*. Utilizaremos microdados da PNAD Contínua do 1º trimestre de 2024, e selecionamos as variáveis de acordo com a tabela abaixo:
...
Observamos que há algumas linhas em que a coluna , que é nossa variável alvo, possui valores ausentes, então neste caso, vamos descartar essas linhas.

```{r, echo=FALSE}
df_variables %<>% filter(!is.na(VD4020))
```
